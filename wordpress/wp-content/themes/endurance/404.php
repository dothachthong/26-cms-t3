...
<main id="site-main">
	...
	<div class="site-page-content">
		<div class="site-section-wrapper site-section-wrapper-main clearfix">
			...
			<div class="archives-content clearfix"><p><?php esc_html_e( 'Apologies, but the requested page cannot be found. Perhaps searching will help find a related page.', 'endurance' ); ?></p></div>
			<hr />
			<?php get_search_form(); ?>
